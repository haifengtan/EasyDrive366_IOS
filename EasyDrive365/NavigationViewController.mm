...
@interface NavigationViewController ()<BMKMapViewDelegate,BMKSearchDelegate>{
    BMKSearch *_search;
    BOOL _hasUserLocation;
    CLLocationCoordinate2D _userCoor;
    BOOL _hasLocatedCenter;
}
...
-(void)mapView:(BMKMapView *)mapView didUpdateUserLocation:(BMKUserLocation *)userLocation{
    if (userLocation != nil) {
        ...
        if (!_hasUserLocation){
         ...
         _userCoor = userLocation.location.coordinate;
        if (!_hasLocatedCenter){
            _hasLocatedCenter = YES;
...
-(void)checkWaypoints{
    ...
    BOOL flag =[_search drivingSearch:@"青岛" startNode:start endCity:@"青岛" endNode:end];
    if (flag) {
